...
function renderSocialIcon(label: string) {
  ...
  if (l.includes("tiktok")) {
    return (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.96-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.82.56-1.36 1.52-1.38 2.52-.01.76.31 1.51.87 2.03.62.59 1.49.91 2.34.86 1.04-.03 2.04-.56 2.6-1.43.43-.65.65-1.44.64-2.22.02-4.99.01-9.99.01-14.98z"/>
      </svg>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[1.25em_1.5em] bg-transparent pointer-events-none z-20"
          aria-label="Main navigation header"
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            <img
              src={logoUrl || "/media/logos/fran-perez-logo-linear.webp"}
              alt="Logo"
        ...
        <aside
          ...
          aria-hidden={!open}
        >
          <div className="sm-panel-inner relative flex-1 flex flex-col justify-between gap-5 z-10">
            {/* Background Large Square Logo */}
            <div className="absolute bottom-0 right-0 pointer-events-none select-none opacity-15 w-56 h-56 sm:w-72 sm:h-72 z-0">
              <img
                src="/media/logos/fran-logo-square.webp"
                alt=""
            ...
            <ul
              className="sm-panel-list relative z-10 list-none m-0 p-0 flex flex-col gap-2"
              role="list"
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials relative z-10 mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-xs font-bold uppercase tracking-[0.2em] [color:var(--sm-accent,#e8590c)]">Socials</h3>
                <ul
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        aria-label={s.label}
                        className="sm-socials-link flex items-center justify-center p-2 text-[#111] hover:text-orange-brand no-underline relative transition-all duration-200 ease-out hover:scale-110"
                        onClick={closeMenu}
                      >
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 1.25em 1.5em; background: transparent; pointer-events: none; z-index: 20; }
