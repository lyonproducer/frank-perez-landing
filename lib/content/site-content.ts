...
const rawSiteManifest: unknown = {
  site: {
    name: "Fran Pérez",
    title: "Fran Pérez | DJ & Productor | Afro House & Organic House",
    description: "Página oficial de Fran Pérez (VE). Descubrí sus últimos lanzamientos de Afro House, fechas de presentaciones, sets de DJ grabados en vivo y contacto de booking.",
  ...
  assets: [
    {
      id: "hero-main-new",
      src: "/media/photos/IMG_2461.webp",
      kind: "photo",
      width: 1170,
      height: 649,
      alt: "Fran Pérez actuando en cabina de DJ",
      caption: "Fran Pérez",
    ...
    {
      id: "hero-horizontal-1",
      src: "/media/photos/fran-hero-horizontal-1.webp",
      kind: "photo",
      width: 2752,
      height: 1536,
      alt: "Fran Pérez actuando, imagen de previsualización 1",
      caption: "Fran Pérez",
      focalPoint: { x: 50, y: 50 },
      publicationStatus: "preview",
      rightsApproved: false,
    ...
    {
      id: "hero-horizontal-2",
      src: "/media/photos/fran-hero-horizontal-2.webp",
      kind: "photo",
      width: 2752,
      height: 1536,
      alt: "Fran Pérez actuando, imagen de previsualización 2",
      caption: "Fran Pérez",
      focalPoint: { x: 50, y: 50 },
      publicationStatus: "preview",
      rightsApproved: false,
